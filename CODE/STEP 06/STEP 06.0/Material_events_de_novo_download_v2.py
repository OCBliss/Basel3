...
OUTPUT_DIR = os.path.join(ROOT_DIR, "Material Events", "DE NOVO", "RAW")
...
def fetch_fdic_history(start_date, end_date, change_codes, limit=10000):
    ...
    fields = [
        "ACQDATE", "ACQYEAR", "CERT", "CHANGECODE_DESC", "CHANGECODE_DESC_LONG", "CHARTAGENT", 
        "CLASS", "CLASS_TYPE", "CLCODE", "EFFDATE", "ESTDATE", "FDICREGION", "FDICREGION_DESC", 
        "FRM_CLASS", "FRM_INSAGENT1", "FRM_REGAGENT", "ID", "INSAGENT1", "INSTNAME", 
        "NEW_CHARTER_DENOVO_FLAG", "NEW_CHARTER_FLAG", "ORGTYPE", "ORGTYPE_NUM", 
        "REGAGENT", "REPORT_TYPE"
    ]
...
if __name__ == "__main__":
    df = fetch_fdic_history("2014-01-01", "2024-12-31", change_codes=[110])
    if df is not None:
        output_path = os.path.join(OUTPUT_DIR, "BankFind Suite API - de novo.csv")
        df.to_csv(output_path, index=False)
        print("✅ CSV saved as 'BankFind Suite API - de novo.csv'")
