        ...
        try:
            ...
            for _, row in signals_df_rcb.iterrows():
                ...
                entry1 = {
                    ...
                    #'RCRI-P859-A223': row['RCOAP793'],
                    'RCRI-P859-A223': row['RCOAP859'] / row['RCOAA223'] if row['RCOAA223'] != 0 else 0,
                    'RCRI-CET1-RWA+': row['RCOAP859'] / RWA_Basel_entry1 if RWA_Basel_entry1 != 0 else 0,
                    'RCRI-CET1-THRES': row['RCOAH311'] if row['RCON9999'] >= 20160311 else 0,
                    # 'RCRI-CET1-CCYB+': row['RCOAP793'] - row['RCFAH311'] if row['RCON9999'] >= 20160331 else 0,
                    # 'RCRI-CET1-A223': RCB_item4c2_htm_ac_xyzentry1 if row['RCOAP838'] == 0 else RCB_item4c2_htm_fv_abcentry1
                }
                ...
                entry2 = {
                    ...
                    ####----Risk-Weighted Assets----####
                    ###---Common Equity Tier 1 Ratio
                    #'RCRI-P859-A223': row['RCFAP793'],
                    'RCRI-P859-A223': row['RCFAP859'] / row['RCFAA223'] if row['RCFAA223'] != 0 else 0,
                    'RCRI-CET1-RWA+': row['RCFAP859'] / RWA_Basel_entry2 if RWA_Basel_entry2 != 0 else 0,
                    'RCRI-CET1-THRES': row['RCFAP793'] if row['RCON9999'] >= 20160331 else 0,
                    # 'RCRI-CET1-CCYB+': row['RCFAP793'] - row['RCFAH311'] if row['RCON9999'] >= 20160331 else 0,
                    # 'RCRI-CET1-A223': RCB_item4c2_htm_ac_xyzentry2 if row['RCOAP838'] == 1 and row['RCFAP859'] != '' else RCB_item4c2_htm_fv_abcentry2
                }
