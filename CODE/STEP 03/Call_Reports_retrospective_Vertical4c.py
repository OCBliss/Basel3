    ...
    if file_name.endswith('.csv'):
        try:
            ...
            for _, row in signals_df_rcb.iterrows():
                ...
                RWA_adjustment_entry1 = (row['RCONA554'] + row['RCONA560'])
                ###---ZRWA
                ...
                entry1 = {
                    ...
                    'RCRI-ZRWA-RWA++': ZRWA_Ratio_entry1*RWA_adjustment_entry1
                }
                ...
                RWA_adjustment_entry2 = (row['RCFDA554'] + row['RCFDA560'])
                ###---ZRWA
                ...
                entry2 = {
                    ...
                    'RCRI-ZRWA-RWA++': ZRWA_Ratio_entry2*RWA_adjustment_entry2
