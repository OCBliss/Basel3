...
# Define directories
cleaned_directory = '/Users/johnnywaller/Desktop/Basel3/Call Report/CSV/Cleaned'
interleaved_directory = '/Users/johnnywaller/Desktop/Basel3/Call Report/CSV/Interleaved'
    ...
    if file_name.endswith('.csv'):
        try:
            ...
            for _, row in signals_df_rcb.iterrows():
                ...
                # --- Calculate RCRI_CET1_norm_entry1 ---
                # if row['RCON9999'] >= 20200331:
                #     if row['RCFAP859'] == '' and row['RCFAP838'] == 0:
                #         RCRI_CET1_norm_entry1 = row['RCOAP859'] + row['RCOAP858'] + row['RCOAP849'] - row['RCOAB530']
                #     elif row['RCFAP859'] == '' and row['RCOAP838'] == 1:
                #         RCRI_CET1_norm_entry1 = row['RCOAP859'] + row['RCOAP858']
                # elif 20150331 <= row['RCON9999'] < 20200331:
                #     if row['RCFAP859'] == '' and row['RCOAP838'] == 0:
                #         RCRI_CET1_norm_entry1 = row['RCOAP859'] + row['RCOAP858'] + row['RCOAP849'] - row['RCOAB530']
                #     elif row['RCFAP859'] == '' and row['RCOAP838'] == 1:
                #         RCRI_CET1_norm_entry1 = row['RCOAP859'] + row['RCOAP858']
                # elif 20140331 <= row['RCON9999'] < 20150331:
                #     if row['RCFAP859'] == '' and row['RCOAP838'] == 0:
                #         RCRI_CET1_norm_entry1 = row['RCOAP859'] + row['RCOAP858']
                #     else:
                #         RCRI_CET1_norm_entry1 = row['RCON8274']
                # else:
                #     RCRI_CET1_norm_entry1 = row['RCON8274']
                #####-----Schedule RC-----#####
                ###---Securities
                ...
                RCB_item3_htm_ac_entry1 = row['RCON8496']
                RCB_item3_htm_fv_entry1 = row['RCON8497']
                RCB_item3_afs_fv_entry1 = row['RCON8499']
                RCB_item3_entry1 = row['RCON8496'] + row['RCON8499']
                ...
                ##--AOCI Adjusted
                RCRI_CET1_AOCI_entry2 = row['RCFAP840']
                ###---Risk-Weighted Assets
                RWA_Basel_entry1 = row['RCOAA223']
                ...
                entry1 = {
                    ...
                    'RCB-8496-1754': RCB_item3_htm_ac_entry1 / row['RCON1754'] if row['RCON1754'] != 0 else 0,
                    'RCB-8499-1773': RCB_item3_afs_fv_entry1 / row['RCON1773'] if row['RCON1773'] != 0 else 0,
                    ...
                    'RCRI-P840-A223': row['RCOAP840'] / row['RCOAA223'] if row['RCON9999'] >= 20150331 else 0,
                    'RCRI-CET1-A223': row['RCOAP793'] if row['RCON9999'] >= 20150331 else 0,
                    ###---Capital Conservation Buffer
                    'RCRI-CET1-H311': row['RCOAH311'] if row['RCOAH311'] >= 20150331 else 0
                }
                ...
                ###---State Issued Securities
                RCB_item3_htm_ac_entry2 = row['RCFD8496']
                RCB_item3_htm_fv_entry2 = row['RCFD8497']
                RCB_item3_afs_fv_entry2 = row['RCFD8499']
                RCB_item3_entry2 = row['RCFD8496'] + row['RCFD8499']
                ...
                entry2 = {
                    ...
                    ###---Securities issued by states and political subdivisions
                    'RCB-8496-1754': RCB_item3_htm_ac_entry2 / row['RCFD1754'] if row['RCFD1754'] != 0 else 0,
                    'RCB-8499-1773': RCB_item3_afs_fv_entry2 / row['RCFD1773'] if row['RCFD1773'] != 0 else 0,
                    ###---Mortgage-backed securities
                    ##--Residential mortgage pass-through securities
                    ...
                    ####----Risk-Weighted Assets----####
                    ###---Common Equity Tier 1 Ratio
                    'RCRI-P840-A223': row['RCFAP840'] / row['RCFAA223'] if row['RCON9999'] >= 20150331 else 0,
                    'RCRI-CET1-A223': row['RCFAP793'] if row['RCON9999'] >= 20150331 else 0,
                    ###---Capital Conservation Buffer
                    'RCRI-CET1-H311': row['RCFAH311'] if row['RCFAH311'] >= 20150331 else 0
                }
