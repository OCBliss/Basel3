...
if __name__ == "__main__":
    survivors_dir = os.path.join(MAT_DIR, "Survivors", "JS Divergence", "Basel III T+1", "Probabilities")
    failures_dir  = os.path.join(MAT_DIR, "Failures",  "JS Divergence", "Basel III T+1", "Probabilities")
    mergers_dir   = os.path.join(MAT_DIR, "Mergers",   "JS Divergence", "Basel III T+1", "Probabilities")
    output_dir    = os.path.join(MAT_DIR, "JSD", "BASEL III T+1")
