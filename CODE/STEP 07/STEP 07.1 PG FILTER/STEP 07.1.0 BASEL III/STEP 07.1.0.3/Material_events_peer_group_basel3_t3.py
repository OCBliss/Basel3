...
# 1) Mergers
# -----------------------------
process_directory3 = os.path.join(MAT_DIR, "Mergers/Peer Group Mergers/Basel III T+3")
...
filter_and_concatenate(
    ...
    output_filename = "Peer_Group_Mergers_Basel3_t3.csv",
...
# 2) Failures
# -----------------------------
process_failures = os.path.join(MAT_DIR, "Failures/Peer Group Failures/Basel III T+3")
output_failures  = os.path.join(MAT_DIR, "Failures/Peer Group Failures")
filter_and_concatenate(
    process_dir     = process_failures,
    output_dir      = output_failures,
    output_filename = "Peer_Group_Failures_Basel3_t3.csv",
    valid_dates     = valid_dates,
    label           = "Failures"
)
...
# 3) Survivors
# -----------------------------
process_survivors = os.path.join(MAT_DIR, "Survivors/Peer Group Survivors/Basel III T+3")
...
filter_and_concatenate(
    ...
    output_filename = "Peer_Group_Survivors_Basel3_t3.csv",
    valid_dates     = valid_dates,
    label           = "Survivors"
)
